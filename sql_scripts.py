...
class SQL:
    ...
    def get_all_course_students(self, how_many):
        self.my_cursor.execute('''Select CS.GradePoints, info.GPA as StudentGPA, info.TotalCreditHours as StudentTotalCreditHours,
    ...
    def get_home_info(self, username, password):
        self.my_cursor.execute('''
            ...
            Where S.StudentId = {}
            and S.StudentPassword = '{}' '''.format(username, password))
        return self.my_cursor.fetchall()

    def get_student_first_name(self, username, password):
        self.my_cursor.execute('''
            SELECT S.FirstName
            FROM Student S
            where S.StudentId = {} and S.StudentPassword = '{}'    
